...
public class Prospectus_Write_to_Excel 
{
	  public static void main(String[] args) throws Exception
	  {
		  ...
		  String location = "C:\\Users\\sleep\\my_projects\\MNS_Markdown\\Programs\\Prospectus_Write_to_Excel_from_Sql\\Database_Downloads\\RePORTER_PRJ_X_FY2022_002.xml";
		  ...
		  try {
		         ...
		         for (int temp = 0; temp < nList.getLength(); temp++) {
		        	 ...
		        	 if (nNode.getNodeType() == Node.ELEMENT_NODE) {
		                 ...
		                 ; //get the data from the node ie: the Name tag name would give "Aubert" or "Sleeper"
      ...
      //TableCreation = "CREATE TABLE DISTRIBUTED ("+ "Administered INT NOT NULL, " +"Distributor VARCHAR(50) PRIMARY KEY, " +
